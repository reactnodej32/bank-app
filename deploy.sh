...
deploy_cluster() {
  ...
  cluster="bank-app-cluster" # for all commits on git this will update the ecs
  
  #$AWS_ACCOUNT_ID
  # Api
  service="bank-app-api-service"  # for all commits on git this will update the ecs
  ...
  # Client
  service="bank-app-client-service"   # for all commits on git this will update the ecs
